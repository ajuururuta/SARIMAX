...
parser.add_argument("--coarse-maxiter", type=int, default=_env_int("COARSE_MAXITER", 200), help="粗筛最大迭代次数，默认 200")
parser.add_argument("--fine-maxiter",   type=int, default=_env_int("FINE_MAXITER", 500), help="精调最大迭代次数，默认 500")
